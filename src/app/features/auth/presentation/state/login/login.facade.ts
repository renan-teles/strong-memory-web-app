...
export class LoginFacade {
  ...
  loginPlayer(data: LoginRequest): void {
    this.handleLogin(this.loginUser.execute(this.api.loginPlayer(data)), '/app/game/start');
  }

  loginAdministrator(data: LoginRequest): void {
    this.handleLogin(this.loginUser.execute(this.api.loginAdministrator(data)), '/app/words/list');
  }
